...
def edit_data():
    ...
    delete_button = Button(edit_window, text='Delete Selected Item', command=delete_item, bg='#D50032', fg="white", width=18, font=('Arial Rounded MT Bold', 8), pady=5)
    delete_button.pack()
    ...
    modify_button = Button(edit_window, text='Modify Selected Item', command=modify_item, bg="#0072C6", fg='white', width=18, font=('Arial Rounded MT Bold', 8), pady=5)
    modify_button.pack()
    ...
    add_button = Button(edit_window, text='Add Item', command=add_item, bg="#0072C6", fg='white', width=18, font=('Arial Rounded MT Bold', 8), pady=5)
    add_button.pack()
    ...
    save_button = Button(edit_window, text='Save Changes', command=save_changes, bg='#4E9F3D', fg='white', width=18, font=('Arial Rounded MT Bold', 8), pady=5)
    save_button.pack()
...
def Generate():
    ...
    edit_button = Button(UI_Frame, text='Edit', command=edit_data, bg='#D50032', fg='white', font=('Arial Rounded MT Bold', 14), width=9, pady=5)
...
UI_Frame = Frame(root, width=400, height=800, bg='#323a65')
...
# User Interface Area
algo_label = Label(UI_Frame, text='Algorithm', bg='#252b4c', fg='white', font=('Helvetica', 16, 'bold'))
algo_label.grid(row=0, column=0, padx=5, pady=5)

# Listbox for Showing Real time text
listbox = Listbox(root, width=100, height=4)
listbox.grid(row=1, column=0)
listbox.config(font=('Consolas', 12), background="#252b4c", fg="white")
...
start_button = Button(UI_Frame, text='Start', command=StartAlgorithm, bg='#4E9F3D', fg='white', font=('Arial Rounded MT Bold', 14), width=9, pady=5)
...
generate_button = Button(UI_Frame, text='Generate', command=Generate, bg='#0072C6', fg='white', font=('Arial Rounded MT Bold', 14), width=9, pady=5)
generate_button.grid(row=8, column=0, padx=5, pady=5)

# Text box for manual user input
input_label = Label(UI_Frame, text='Input Values', bg='#252b4c', fg='white', font=('Helvetica', 12, 'bold'))
...
# UI Search Frame
UI_SearchFrame = Frame(root, width=400, height=400, bg='#323a65')
UI_SearchFrame.grid(row=0, column=2, padx=10, pady=10, sticky=N)

# User Interface Area for search

search_label = Label(UI_SearchFrame, text='Search', bg='#252b4c', fg='white', font=('Helvetica', 16, 'bold'))
...
SearchSpeedScale.configure(sliderrelief="flat", activebackground='#D50032')
SearchSpeedScale.grid(row=2, column=0, padx=5, pady=5)

# Text box for manual search input
input_SearchLabel = Label(UI_SearchFrame, text='Input search element', bg='#252b4c', fg='white', font=('Helvetica', 12, 'bold'))
...
search_button = Button(UI_SearchFrame, text='Search', command=StartSearching, bg='#D50032', fg='white', font=('Arial Rounded MT Bold', 14), width=9, pady=5)
